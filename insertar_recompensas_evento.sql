...
-- Script para insertar recompensas entre 1-3 jugadores por evento
-- Supone que hay al menos eventos_zombi.id del 1 al 5 y jugadores.id del 1 al 3
    ...
    WHILE evento_id <= 5 DO
        ...
        WHILE i <= recompensas DO
            ...
            VALUES (
                evento_id,
                jugador_id,
                ELT(FLOOR(1 + RAND() * 5), 'Kit médico', 'Granada', 'Katana rara', 'XP Boost', 'Doblón de oro'),
